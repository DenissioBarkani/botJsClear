...
client.on('ready', function() {
    client.user.setActivity(`${client.commandPrefix}ком и ${client.commandPrefix}help и ${client.commandPrefix}invite `, { type: 'PLAYING' });
...
client.login('ODIyOTAwMTUzNzUxOTYxNjEx.YFY_fQ.DCbLATZGyeWE3Cng7992XqmLckI');